...
const V_LICENSE_SECRET = process.env.LICENSE_SECRET || '';
const V_ADMIN_USER = process.env.ADMIN_USER || '';
const V_ADMIN_PASSWORD = process.env.ADMIN_PASSWORD || '';
const V_ADMIN_KEY = process.env.ADMIN_KEY || ''; // sin valor por defecto: si no esta en el entorno, no vale
